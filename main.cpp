...
//    showing board
    ...
    while (true)
    {
        ...
        //checking if your two numbers are connected with each other or not
...
//            showing your board with new
            ...
            while (true)
            {
                cout << "enter another two num & they must be connected with each other : \n ";
                cin >> m >> n;
                if ((((m > 0 && (m <= 16)) && (n > 0) && (n <= 16)) && ((board[m] != "x") && (board[n] != "x"))) && (((n > m) && (n - m == 1) && (m % 4 != 0)) || ((n > m) && (n - m == 4)) || ((m > n) && (m - n == 1) && (n % 4 != 0)) || ((m > n) && (m - n == 4))))
                {
                    board[m] = "x";
